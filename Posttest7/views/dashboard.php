<?php
    ...
    if(isset($_POST['keyword'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM karakter_genshin WHERE nama LIKE '%$keyword%'");
    } else {        
    ...
    <div class="dashboard">
        ...
        <nav class="navbar shadow" id="navbar">
            ...
            <section class="dash-main">
                <h1>Halo !</h1>
                <h3><?php date_default_timezone_set('Asia/Makassar'); echo date("l d/m/Y H:s:i a"); ?> </h3><br>
                <hr><br>
