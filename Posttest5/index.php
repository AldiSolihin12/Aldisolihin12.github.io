                ...
                <div class="table">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-text"><?php echo $chr['elemen']; ?></h4>
                            <p class="card-text"><?php echo $chr['tgllahir']; ?></p>
                            <p class="card-text"><?php echo $chr['deskripsi']; ?></p>
                        </div>
                    </div>
                    <?php if ($i % 3 == 0) echo '</div><div class="table">';
                    $i++;
                    endforeach; ?>
                </div>
            </div>
