            ...
            <ul class="menu" id="menu">
                ...
                <?php
                    if (isset($_SESSION['username']) or isset($_SESSION['admin'])) {
                        echo "<h3>$loginText</h3>";
                        echo "<a href='logout.php'><button type='button' class='btn-login'>Logout</button></a>";
                    } else {
                        echo "<a href='login.php'><button type='button' class='btn-login'>$loginText</button></a>";
                    }
                ?>
            </ul>
                ...
                <?php if ($result->num_rows > 0) : ?>
                    ...
                    <div class="table">
                        ...
                        <div class="card shadow">
                            <img src="../assets/uploadedImg/<?php echo $chr['gambar']; ?>">
                            <div class="card-body">
                                <h2 class="card-text"><?php echo $chr['nama']; ?></h2>
                                <h4 style="margin-bottom: 8px;" class="card-text"><?php echo $chr['elemen']; ?></h4>                                
                                <p class="card-text"><?php echo $chr['deskripsi']; ?></p><br>
                            </div>
                        </div>  
                        <?php $i++; endforeach; ?>
                        </div>
