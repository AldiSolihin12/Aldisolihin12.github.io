...
function mode(){
    ...
    const ubah1 = document.body;
    const ubah2 = document.querySelector('.navbar');
    var ubah3 = document.getElementById('logo2');
    var ubah4 = document.getElementById('logo3');
    const ubah5 = document.getElementById("webicon");
    
    menu.classList.toggle("dark1")
    menuToggle.classList.toggle("dark")
    ubah1.classList.toggle("dark1");
    ubah2.classList.toggle("dark1");
